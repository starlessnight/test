...
class Client13 extends Frame implements ActionListener, Runnable {
	...
	public static void main(String args[]) {
		if (args.length < 3) {
			System.out.println("USAGE: java Client13 [iaddr] [port] [user]");
			System.exit(1);
		}
		...
		user = args[2];
		Client13 ClientStart = new Client13();
	}
}
