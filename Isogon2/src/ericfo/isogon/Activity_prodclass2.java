...
public class Activity_prodclass2 extends Activity implements OnClickListener {
	...
	private static int UrlID,Nextpage=0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(UrlID != 0){
			urlApi = "http://www.isogon.com.tw/Isogon_M/main/Products.aspx?productclass_id=c000000"	+ UrlID;
		}else if(!(SendUrl.equals(""))){
			urlApi = "http://www.isogon.com.tw/Isogon_M/main1/Products.aspx?"+ SendUrl;
		}
	...
	private void ImageLoaderOptions() {
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
        		...
        		Bundle bundle = new Bundle(); 
        		bundle.putString("UrlStr",UrlListArray.get(arg2+(Nextpage*6))); 
        		System.out.println("UrlListArray.get(arg2)="+UrlListArray.get(arg2));
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	    if(keyCode == KeyEvent.KEYCODE_BACK&&event.getRepeatCount()==0) {
	        // 监控返回键
	    		...
	    		Nextpage=0;
	           	Activity_prodclass2.this.finish();
