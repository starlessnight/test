...
public class MainActivity extends Activity {
	...
	public String endLocation = "楠梓火車站";
	...
	private void init() {
		...
		*/
		...
		@Override
		public void run(){GetDirection(startLocation,endLocation);}
		};
		theard.start();
		}
		...
		if (httpResponse.getStatusLine().getStatusCode() == 200)
			...
			// ��Xroutes�}�C���U��overview_polyline ���󤺪�points (�g�s�X�L�᪺��T���e)
			if (polyline.length() > 0)
			{
			drawPath(decodePoly(polyline));
			/*
			�����decodePoly �N�s�X�����|��m�ഫ���� ArrayList<LatLng> �æ^�ǵ�
			drawPath function�A�ӵ��w�Ҧ����|�I�ù�{ø�s���u���\��
			*/
			}
			}
			}catch (Exception e)
		...
		.title("�ڬO�_�I")
		.snippet("�ڬO�_�I"));
		//�ϥ�Marker�ӼХܸ��|���_�I�Apoints.get(0) -> ��Ҧ��}�C���|�I�Ĥ@��(�_�I)��T
		map.addMarker(new MarkerOptions()
		...
		//����Camera�����ʮĪG�A�åH�_�I�������I�A�Y����15.5�A����ɶ���׬�2000 ms
		}
		};
		handler.post(r1);
		}
