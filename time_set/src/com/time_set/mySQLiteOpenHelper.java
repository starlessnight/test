...
public class mySQLiteOpenHelper extends SQLiteOpenHelper
{
  ...
  public final static String PROCESS_mode = "mode";
 ...
 public mySQLiteOpenHelper(Context context,String name) { 
  ...
  public void onCreate(SQLiteDatabase db)
  {
    ...
    String sql = "CREATE TABLE " + TABLE_NAME + " (" + PROCESS_id
        + " INTEGER primary key autoincrement, "  + PROCESS_name + " TEXT,"+PROCESS_ftTime+" TEXT,"+PROCESS_lstTime+" TEXT,"+PROCESS_weekday+" TEXT,"+PROCESS_mode+" TEXT)";
    db.execSQL(sql);
  }
	...
	//oldVersion=舊的資料庫版本；newVersion=新的資料庫版本
	  ...
	  if (newVersion > oldVersion) {
	   db.beginTransaction();//建立交易
	    ...
	    switch (oldVersion) {
	    case 2:           
	      db.execSQL("ALTER TABLE process ADD COLUMN mode TEXT ");
	      oldVersion++;
  ...
  public long insert(String name,String ftTime,String lstTime,String weekdays,String mode)
  {
  ...
  public void update(int id,String name,String ftTime,String lstTime,String weekdays,String mode)
  {
    SQLiteDatabase db = this.getWritableDatabase();
    String where = PROCESS_id + " = ?";
    String[] whereValue =
