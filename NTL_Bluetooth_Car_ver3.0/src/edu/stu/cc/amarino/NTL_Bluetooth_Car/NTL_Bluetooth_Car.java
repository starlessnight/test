...
public class NTL_Bluetooth_Car extends Activity implements
	...
	private void update_Forward() {
		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, 'F', B);
	}
	...
	private void update_Left() {
		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, 'L', green);
	}
	...
	private void update_Stop() {
		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, 'S', blue);
	}
